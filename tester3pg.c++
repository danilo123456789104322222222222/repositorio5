...
int main() {
    ...
    while (true) {
        ...
        std::cout << "1. Exibir equipamento" << std::endl;
        std::cout << "2. Adicionar item ao inventário" << std::endl;
        std::cout << "3. Remover item do inventário" << std::endl;
        std::cout << "4. Exibir inventário" << std::endl;
        ...
        if (opcao == 1) {
            ...
            std::cout << "Digite um item para adicionar ao inventário: ";
            std::cin.ignore();
            ...
            std::cout << "\nInventário atualizado:" << std::endl;
